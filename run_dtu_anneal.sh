...
drop_rate=1.0 
near_n=2 
exp_name=${dataset_type}_${images}_${flow_type}_${flow_checkpoint}_scalelr${scaling_lr}_depth${depth_weight}_near${near_n}_size${size_threshold}_valid${valid_dis_threshold}_drop${drop_rate}_N${split_num}__0.01sparsedrop
...
workspace=output/exp_anneal/dtu/$exp_name/$name/${n}_views
