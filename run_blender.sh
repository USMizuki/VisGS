...
exp_name=${dataset_type}_${images}_${flow_type}_${flow_checkpoint}_scalelr${scaling_lr}_depth${depth_weight}_near${near_n}_size${size_threshold}_prune${prune_interval}_valid${valid_dis_threshold}_drop${drop_rate}_N${split_num}_white_11_2
