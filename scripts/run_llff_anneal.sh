...
drop_rate=1.0
near_n=2
exp_name=${dataset_type}_${images}_${flow_type}_${flow_checkpoint}_scalelr${scaling_lr}_depth${depth_weight}_near${near_n}_size${size_threshold}_valid${valid_dis_threshold}_drop${drop_rate}_N${split_num}_1
...
workspace=output/exp_anneal/llff/$exp_name/$name/${n}_views
...
#     --drop_rate 1.0 \
#     --near_n 2 \
    # --save_iterations 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000 \
python train_with_anneal.py --source_path $dataset --model_path $workspace --eval --n_views $n \
