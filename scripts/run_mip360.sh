...
# names=(bonsai counter kitchen room)
#names=(orchids)
#n_views=(2 3 4 6 9)
n_views=(24)
...
exp_name=mip360_images_8_weight_things_scalelr0.005_depth0_near24_size-1_valid0.1_drop0.05_N2
# exp_name=mip360_images_8_avg_things_scalelr0.005_depth0_near24_size-1_valid0.1_drop0.05_N2
# exp_name=mip360_images_8_avg_things_scalelr0.005_depth0_near1_size-1_valid0.1_drop0.05_N2
...
python render.py --source_path $dataset  --model_path  $workspace --iteration 10000 --render_depth --video
