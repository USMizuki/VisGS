...
names=(chair drums hotdog lego materials mic ship)
# names=(mic ship)
#n_views=(2 3 4 6 9)
n_views=(8)
...
exp_name=${dataset_type}_${images}_${flow_type}_${flow_checkpoint}_scalelr${scaling_lr}_depth${depth_weight}_near${near_n}_size${size_threshold}_prune${prune_interval}_valid${valid_dis_threshold}_drop${drop_rate}_N${split_num}_white_colmap
...
dataset=dataset/nerf_synthetic/$name
workspace=output/exp/blender/$exp_name/$name/${n}_views
...
#     --save_iterations 4000 5000 10000 \
#     --sample_pseudo_interval 1000000 --start_sample_pseudo 0 --end_sample_pseudo 0 \
#     --iterations 10000 \
#     --iterations_pre 0 \
