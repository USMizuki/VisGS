...
exp_name=output/exp/dtu/dtu_images_4_grad_things_scalelr0.005_depth0.001_near2_size-1_valid2.0_drop1.0_N2_11
...
dataset=dataset/dtu-colmap/$name
workspace=$exp_name/$name/3_views
...
python render_dtu.py --source_path $dataset  --model_path  $workspace --iteration 10000 --video
